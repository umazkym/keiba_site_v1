...
const faqItems: FAQItem[] = [
    ...
    // データ分析について（重要度：高）
    {
        ...
        answer:
            '機械学習により算出した馬の能力スコアを偏差値形式で表示したものです。50が平均値で、数値が高いほどその統計分析では能力が高いと評価されています。ただし、あくまで過去データに基づく推定値であり、実際の結果とは異なる場合があります。',
        importance: 'high',
    },
    {
        id: 'prediction-2',
        ...
        answer:
            '本サイトの分析データは参考情報としてご活用ください。過去のデータマッチ結果はサイト内でご確認いただけます。ただし、競馬は様々な予測不可能な要因に左右されるため、結果を保証するものではありません。',
        importance: 'high',
    },
    {
        id: 'prediction-3',
    ...
    },
    {
        ...
        answer:
            '初心者には「複勝」または「単勝」をお勧めします。ルールがシンプルで、分析データを理解しやすいためです。複勝は単勝より該当率が高く、初心者向けです。詳しくは「馬券の買い方・種類徹底解説」の記事をご参照ください。',
        importance: 'medium',
    },
    {
        id: 'ticket-3',
