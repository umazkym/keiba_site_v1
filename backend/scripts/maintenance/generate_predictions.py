...
使い方:
    python backend/scripts/maintenance/generate_predictions.py --date 2026-01-25
    python backend/scripts/maintenance/generate_predictions.py --date today
    python backend/scripts/maintenance/generate_predictions.py --date tomorrow
"""
