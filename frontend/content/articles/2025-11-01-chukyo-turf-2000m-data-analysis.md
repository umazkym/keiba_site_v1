...
差し馬の勝率が35%と最も高く、先行馬がそれに続く。一方で逃げ馬の勝率は15%と低く、単騎で逃げ切る展開はかなり難しいだ。
...
中枠である5〜6枠が複勝率30.1%と首位に立っているものの、最も低い1〜2枠でも26.4%を維持しており、大きな不利となる枠は存在しない。
...
脚質と枠順のデータを踏まえた買い目の組み立ての基準は以下の通りだ。
...
- **注意点**: データ上、枠順による大きな有利不利はないため、あくまで純粋な馬の脚質と急坂適性を最優先に比較検討する。

## 中京芝2000mはスタミナと持続力が実力を分ける

差し馬の勝率35%と、枠番別複勝率のフラットな数値（最高30.1%〜最低26.4%）は、中京芝2000mがポジションの有利不利よりも、馬自身の十分な体力を問う舞台であることを示している。
