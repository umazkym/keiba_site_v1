...
export const metadata: Metadata = {
  ...
  description:
    "競馬データ分析サイトを選ぶときに見るべき項目を整理。無料範囲、指数の根拠、成績公開、地方競馬対応、広告表示、登録要否を比較します。",
  alternates: {
...
const criteria = [
  ...
  {
    title: "成績の見せ方",
    body: "良かった日だけでなく、結果とずれたレースや慎重に見る条件まで公開しているかを見ると、長く使えるか判断できます。",
  },
  {
    title: "地方競馬対応",
      ...
      <article className="mx-auto max-w-4xl px-4 pb-12 pt-6">
        <header className="border-b border-slate-200 pb-8">
          ...
          <p className="mt-4 text-base leading-8 text-slate-600">
            ...
            無料で見られる範囲、指数の根拠、成績の見せ方、レース直前の使いやすさを分けて確認します。
          </p>
        </header>
        ...
        <section className="mt-10 border border-slate-200 bg-slate-50 p-5">
          ...
          <ul className="mt-4 grid gap-3 text-sm leading-7 text-slate-600 sm:grid-cols-2">
            ...
            <li className="bg-white p-4">予測成績ページで、良い条件と慎重に見る条件を継続して整理します。</li>
