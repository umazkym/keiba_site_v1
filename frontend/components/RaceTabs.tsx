...
const VenuePanel = ({ venue }: { venue: VenueRaces }) => {
    ...
    return (
        <div>
            ...
            {activeRace && (
                <div className="mt-2">
                    {/* レース情報、スタート予測、AI予測を一つのブロックにまとめる */}
                    ...
                    {/* 詳細情報 (直接対決データ, 馬番有利不利) はアコーディオン形式 */}
...
export const RaceTabs = ({ data }: { data: RaceDayPrediction }) => {
    ...
    return (
        <Tabs className="mt-6" selectedTabClassName="!text-primary-dark !bg-white border-gray-200 !border-b-white" >
