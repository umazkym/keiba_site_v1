        ...
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-5">
          ...
          >
            <div className="space-y-1.5">
              ...
              <div className="h-1.5 rounded-full bg-slate-100"><div className="h-1.5 w-[88%] rounded-full bg-blue-600" /></div>
              <div className="h-1.5 rounded-full bg-slate-100"><div className="h-1.5 w-[72%] rounded-full bg-slate-500" /></div>
              <div className="h-1.5 rounded-full bg-slate-100"><div className="h-1.5 w-[61%] rounded-full bg-amber-500" /></div>
            </div>
          </FeaturePreviewCard>
          ...
          >
            <div className="grid grid-cols-3 gap-1.5 text-center text-[10px] font-bold">
              {['+2', '0', '-1', '+1', '+3', '0', '-2', '+1', '+2'].map((value, index) => (
                <span
                  key={`${value}-${index}`}
                  className={`rounded-md py-1 ${value.startsWith('+') ? 'bg-emerald-50 text-emerald-700' : value.startsWith('-') ? 'bg-rose-50 text-rose-700' : 'bg-slate-100 text-slate-500'}`}
                >
                  {value}
                </span>
              ))}
          ...
          >
            <div className="space-y-1.5 rounded-lg bg-slate-50 p-2 text-[10px] text-slate-600">
