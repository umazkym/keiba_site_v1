...
export function RaceConditionComparison({ raceId }: { raceId: string }) {
    ...
    return (
        <details
            className="race-panel group overflow-hidden sm:mb-1.5"
            onToggle={(event) => {
        ...
        >
            <summary className="flex min-h-11 cursor-pointer list-none items-center justify-between gap-3 px-3.5 py-2.5 text-sm font-bold text-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary/30 sm:px-4">
                ...
                <span className="hidden shrink-0 whitespace-nowrap text-xs font-semibold text-slate-500 group-open:inline">閉じる</span>
            </summary>
