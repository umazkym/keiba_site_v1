    ...
    try:
        if use_selenium:
            ...
            try:
                ...
                print(f"[Selenium Error] Failed to get page {url}: {e_sel}")
                return None
            finally:
                if driver:
                    driver.quit()
        ...
        print(f"[Request Error] Failed to get page {url}: {e_req}")
        return None
    except Exception as e_gen:
        print(f"[General Error] Failed to get page {url}: {e_gen}")
        return None
