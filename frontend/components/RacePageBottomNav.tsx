...
export function RacePageBottomNav() {
    ...
    return (
        <nav
            className={`fixed inset-x-0 bottom-0 z-40 border-t border-slate-300 bg-slate-50/95 px-2 pb-[calc(env(safe-area-inset-bottom)+0.25rem)] pt-1 shadow-[0_-6px_18px_rgba(15,23,42,0.10)] backdrop-blur-sm transition-[transform,opacity] duration-200 md:hidden ${isVisible
