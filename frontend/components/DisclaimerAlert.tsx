            ...
            <div className="md:hidden">
                ...
                >
                    <div className="flex min-w-0 items-center gap-2">
                        ...
                        <span className="truncate text-xs font-bold text-amber-800">免責事項：AI分析は参考情報です</span>
                    </div>
                    <svg className={`h-4 w-4 shrink-0 text-amber-500 transition-transform duration-200 ${isExpanded ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                {isExpanded && (
                    <div className="space-y-1 border-t border-amber-200 px-3 pb-2 pt-1.5 text-[11px] leading-relaxed text-amber-700">
