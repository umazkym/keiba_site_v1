            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl mx-auto">
                {sortedGuides.map((guide) => (
                    <Link
                        ...
                        key={guide.slug}
                        className="flex flex-col gap-4 p-6 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 bg-white hover:translate-y-[-2px]"
                    >
                        {/* ガイドカテゴリーバッジ */}
