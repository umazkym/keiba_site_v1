...
const advertisingContent: AdvertisingContent = {
    ...
    sections: [
        ...
        },
        {
            ...
            content: "当サイトでは、商品紹介リンクや投票サイトへの案内リンクなどにアフィリエイト広告を利用する場合があります。リンク先で商品購入、会員登録、サービス利用などが行われた場合、当サイトが紹介料を受け取ることがあります。アフィリエイト広告を掲載する場合は、ページまたは広告枠内に「PR」などの表示を行い、通常のコンテンツと区別できるよう努めます。",
        },
        {
