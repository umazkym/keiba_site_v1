# backend/scripts/maintenance/db_health_checker.py
import os
import sys
...
def check_database_health(start_date_str: str = None):
    ...
    if is_full_audit:
        ...
        print("💡 全期間をチェックしたい場合は、開始日を指定してください。(例: python backend/scripts/maintenance/db_health_checker.py 2024-01-01)")
